...
manifest-sha256: sha256:aa1e048b5f56d9f89fed5eaad88f89ae58ef9067661d5dac971da9313e0777e4
sources-sha256: sha256:35b171bb85ffa1c6b05316eed1401efb5670b87e02249363db9e1610bea0fab9
deps-sha256: sha256:2569ac43ba892d14db3f76db745a5714e00f732588d16676466a2740cf969ca5
claims-sha256: sha256:8ba01ffceb968a4d397c1ed2b84245807ac38cc7745482e8bda476494e0b5f13
sbom_ref: "release asset: class-list-builder-v2.0.2.cdx.json"
status: pass
exceptions-cited: [CLB-EXC-0001]
---

# Security Audit — v2.0.2
...
This release supersedes the v2.0.1 audit (`.security/audits/2.0.1.md`),
which was never signed off because the release workflow failed due to an
incorrect `anchore/sbom-action` commit SHA. That SHA has been corrected
in `.github/workflows/release.yml` for this release.
...
5. **Version bump** — `package.json` and `src/defaults.js` bumped to 2.0.2.
...
- Diff reviewed between v2.0.0 and v2.0.2 to confirm no functional changes.
...
and attached to the GitHub Release as `class-list-builder-v2.0.2.cdx.json`.
