...
function SaveProjectModal({ onClose }) {
  ...
  return (
    <Modal isOpen={true} onClose={onClose} title="Save Project" size="md" footer={footer}>
      <div className="save-project-summary">
        <p style={{ marginBottom: 16, color: 'var(--text2)' }}>
          Save your complete working state to a file. You can load this project later to continue
          where you left off.
        </p>
        ...
        >
          <strong>Privacy note:</strong> This file contains all student data. Store it securely and
